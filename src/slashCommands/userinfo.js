...
module.exports = {
    ...
    async run(client, interaction){
        ...
        if(member!==undefined){
            ...
            .setColor(user.hexAccentColor)
            .setThumbnail(member.avatar!==null?`https://cdn.discordapp.com/avatars/${user.id}/${member.avatar}.${member.avatar.startsWith('a_')?'gif':'png'}?size=1024`:user.defaultAvatarURL);
