...
exports.run = async (client, message, args) => {
    ...
    const Rules4 = new Discord.MessageEmbed()
        ...
        .addField(`${client.emojis.cache.get("832268444682027009")} **- MIEMBRO**`, `Todos los usuarios tienen este rol y te proporciona acceso al uso del servidor.`)
        .addField(`${client.emojis.cache.get("832268444682027009")} **- LLAMA REPORTERA**`, `Los usuarios con este rol tienen permisos para publicar noticias en sus respectivos canales.`)
        .addField(`${client.emojis.cache.get("832268444682027009")} **- LLAMA HONORIFICA**`, `Este rol le pertenece a los usuarios que son parte del Staff de Fortnite Hispanohablante.`)
        ...
        .addField(`${client.emojis.cache.get("832268444682027009")} **- LLAMA MITICA**`, `Son los maximos Administradores del servidor.`)
        .setColor('#EF9237')
